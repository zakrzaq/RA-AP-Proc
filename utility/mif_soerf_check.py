def mif_soerf_check(server=False):
    ...
    if soerfs_submitted.empty:
        output += output_msg(server, 'No SOERF have been submitted by you')
    else:
    ...
    output += output_msg(server,
                         f'SOERFs Requests in the submission folder: {soerf_count} \n')
