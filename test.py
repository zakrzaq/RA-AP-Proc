...
# else:
#     print(need_price[["Date Added", "pricing request"]].head(20))
...
if active_wt_pce_req.empty:
    ...
    print(need_pce[["Date Added", "Date of PCE review", "PCE cert rev req'd"]].head(20))
    print(need_pce["Date Added"].unique())
    print(need_pce["Date of PCE review"].unique())
    print(need_pce["PCE cert rev req'd"].unique())
