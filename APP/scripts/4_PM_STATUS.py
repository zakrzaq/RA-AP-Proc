...
selected_active_view.loc[
  (selected_active_view['status'].str.contains('needs price;')) & (~selected_active_view['target sorg price'].isna()),
  'status'
...
# VERIFY GTS
selected_active_view.loc[
  (selected_active_view['status'].str.contains('GST data needed;')) & ((~selected_active_view['INDIA GST\nINHTS'].isna()) | (~selected_active_view['INDIA GST\nmarc.stuec'].isna())),
  'status'
] = selected_active_view['status'].str.replace('GST data needed;', '')

# VERIFY LOCAL
selected_active_view.loc[
  (selected_active_view['status'].str.contains('Localization required;')) & (~selected_active_view['target plant mrp type'].isin(['ND'])),
  'status'
