...
## PRICE REQUEST FILE
need_price_list_file = r"C:\Users\jzakrzewski\OneDrive - Rockwell Automation, Inc\Desktop\AP pricing needed with active demand {0}.xlsx".format(today)
...
## PCE REQUEST FILE - AM
need_pce_file = r"C:\Users\jzakrzewski\OneDrive - Rockwell Automation, Inc\Desktop\\{0} PCE ASSESSMENT REQUEST.xlsx".format(today)
