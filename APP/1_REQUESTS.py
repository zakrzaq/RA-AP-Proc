...
if not requests.empty:
  ...
  try:
    ...
    for cell in ws_active['B']:
      if cell.value is None:
        ...
        break
  except: print('could not populate data ')
  ...
  except: print('could not extend formulas')
  ...
  try:
    ...
    while i < sort_count:
      ...
      i += 1
  except: print('could not create sort order')

  ready_to_save = True

else: print('no request files found')

if ready_to_save:
  # TESTING
  # log.save('test_01.xlsm')
  # print('mock save')
  # ACTUAL
  log.save(log_file)
